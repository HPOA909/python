#reference https://hackanons.com/2018/08/python-3-project-gui-text-editor-using-tkinter-file-handling.html
...
new_file_icon = PhotoImage(file=path+'new_file.png')
open_file_icon = PhotoImage(file=path+'open_file.png')
save_file_icon = PhotoImage(file=path+'save.png')
cut_icon = PhotoImage(file=path+'cut.png')
copy_icon = PhotoImage(file=path+'copy.png')
paste_icon = PhotoImage(file=path+'paste.png')
undo_icon = PhotoImage(file=path+'undo.png')
redo_icon = PhotoImage(file=path+'redo.png')
find_icon = PhotoImage(file=path+'find_text.png')
...
for i, icon in enumerate(icons):
    tool_bar_icon = PhotoImage(file=path+'{}.png'.format(icon))
    cmd = eval(icon)
