#Reference https://www.geeksforgeeks.org/image-viewer-app-in-python-using-tkinter/
...
def forward(img_no): 
	...
	label.grid_forget() #to get rid of the current image
...
image_no_1 = ImageTk.PhotoImage(Image.open(path+"Occupation_1.png")) 
image_no_2 = ImageTk.PhotoImage(Image.open(path+"Occupation_2.png")) 
image_no_3 = ImageTk.PhotoImage(Image.open(path+"Occupation_3.png")) 
image_no_4 = ImageTk.PhotoImage(Image.open(path+"Occupation_4.png")) 
image_no_5 = ImageTk.PhotoImage(Image.open(path+"Occupation_5.png")) 
image_no_6 = ImageTk.PhotoImage(Image.open(path+"Occupation_6.png")) 
# List of the images so that we traverse the list 
List_images = [image_no_1, image_no_2, image_no_3, image_no_4, image_no_5, image_no_6] 
