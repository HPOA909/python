#text editor
#we are going to implement save  functions
#we will make changes to open_file function and add a function save_file
#we also create a few global variable
...
#**** add a command to Save menu item
